  ...
  return (
    <>
      <div className="container-fluid g-0">
        ...
        )) :<div className="container position-absolute top-50 text-center" style={{transform:"translate(-50%,-50%)",left:"50%"}}> Currently no project is assign for you  {project?.length}</div>}
      </div>
    </>
  );
};
