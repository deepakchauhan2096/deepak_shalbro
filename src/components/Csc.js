...
function Csc() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://maps.googleapis.com/maps/place/autocomplete/json?input=country&types=(regions)&key=${apiKey}`
      )
      .then((response) => {
  ...
  useEffect(() => {
    ...
    if (selectedCountry) {
      axios
        .get(
          `https://maps.googleapis.com/maps/place/autocomplete/json?input=${selectedCountry} state&types=(regions)&key=${apiKey}`
        )
        .then((response) => {
          if (response.data.predictions) {
  ...
  useEffect(() => {
    ...
    if (selectedState) {
      axios
        .get(
          `https://maps.googleapis.com/maps/place/autocomplete/json?input=${selectedState} city&types=(regions)&key=${apiKey}`
        )
        .then((response) => {
          if (response.data.predictions) {
