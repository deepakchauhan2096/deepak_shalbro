      ...
      >
         <table className="table table-bordered table-fixed table-sm">
          ...
          <tbody>
            <tr>
              <td>Project lat</td>
              <td>{markerPosition?.lat && markerPosition?.lng ? markerPosition?.lat : "Not Selected"}</td>
              <td>Project lng</td>
              <td>{markerPosition?.lat && markerPosition?.lng ? markerPosition?.lng : "Not Selected"}</td>
            </tr>

            <tr>
              <td>Location Name</td>
              <td colSpan="3">{locationName?.length > 0 ? locationName : "Not Selected"}</td>
            </tr>
